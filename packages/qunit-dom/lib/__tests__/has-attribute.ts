    ...
    test('succeeds for matching name and value', () => {
      ...
      expect(assert.results).toEqual([
        ...
        },
        {
          actual: 'Element input[type="password"] has attribute "type" with value "password"',
          expected:
            'Element input[type="password"] has attribute "type" with value matching /^pass/',
          message:
            'Element input[type="password"] has attribute "type" with value matching /^pass/',
          result: true,
        },
    ...
    test('fails for wrong value', () => {
      ...
      expect(assert.results).toEqual([
        ...
        },
        {
          actual: 'Element input[type="password"] has attribute "type" with value "password"',
          expected:
            'Element input[type="password"] has attribute "type" with value matching /mail$/',
          message:
            'Element input[type="password"] has attribute "type" with value matching /mail$/',
          result: false,
        },
  ...
  describe('{ any: true }', () => {
    test('succeeds for existing attribute', () => {
      ...
      assert
        ...
        .hasAttribute('type', { any: true }, 'custom message');
    ...
    test('fails for missing attribute', () => {
      ...
      assert
        .dom(document.querySelector('input'))
        .hasAttribute('disabled', { any: true }, 'custom message');
