...
const ensureElement = require('../helpers/ensure-element');
...
function textContains(el, text, message) {
  if (!ensureElement.call(this, el)) return;
  let element = this._find(el);
  if (!ensureElement.call(this, element, el)) return;
